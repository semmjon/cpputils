...
namespace dt_utils
{
   ...
   struct base_format
   {
      base_format(datetime& d) : dt(d) {}
      datetime& dt;
   };

   /* YYYYMMDD    */ struct date_format00 : public base_format { date_format00(datetime& d) : base_format(d) {} };
   /* YYYYDDMM    */ struct date_format01 : public base_format { date_format01(datetime& d) : base_format(d) {} };
   /* YYYY/MM/DD  */ struct date_format02 : public base_format { date_format02(datetime& d) : base_format(d) {} };
   /* YYYY/DD/MM  */ struct date_format03 : public base_format { date_format03(datetime& d) : base_format(d) {} };
   /* DD/MM/YYYY  */ struct date_format04 : public base_format { date_format04(datetime& d) : base_format(d) {} };
   /* MM/DD/YYYY  */ struct date_format05 : public base_format { date_format05(datetime& d) : base_format(d) {} };
   /* YYYY-MM-DD  */ struct date_format06 : public base_format { date_format06(datetime& d) : base_format(d) {} };
   /* YYYY-DD-MM  */ struct date_format07 : public base_format { date_format07(datetime& d) : base_format(d) {} };
   /* DD-MM-YYYY  */ struct date_format08 : public base_format { date_format08(datetime& d) : base_format(d) {} };
   /* MM-DD-YYYY  */ struct date_format09 : public base_format { date_format09(datetime& d) : base_format(d) {} };
   /* DD.MM.YYYY  */ struct date_format10 : public base_format { date_format10(datetime& d) : base_format(d) {} };
   /* MM.DD.YYYY  */ struct date_format11 : public base_format { date_format11(datetime& d) : base_format(d) {} };
   /* DD-Mon-YY   */ struct date_format12 : public base_format { date_format12(datetime& d) : base_format(d) {} };
   /* ?D-Mon-YY   */ struct date_format13 : public base_format { date_format13(datetime& d) : base_format(d) {} };
   /* DD-Mon-YYYY */ struct date_format14 : public base_format { date_format14(datetime& d) : base_format(d) {} };
   /* ?D-Mon-YYYY */ struct date_format15 : public base_format { date_format15(datetime& d) : base_format(d) {} };

   /* HH:MM:SS.mss */ struct time_format0 : public base_format { time_format0(datetime& d) : base_format(d) {} };
   /* HH:MM:SS     */ struct time_format1 : public base_format { time_format1(datetime& d) : base_format(d) {} };
   /* HH MM SS mss */ struct time_format2 : public base_format { time_format2(datetime& d) : base_format(d) {} };
   /* HH MM SS     */ struct time_format3 : public base_format { time_format3(datetime& d) : base_format(d) {} };
   /* HH.MM.SS.mss */ struct time_format4 : public base_format { time_format4(datetime& d) : base_format(d) {} };
   /* HH.MM.SS     */ struct time_format5 : public base_format { time_format5(datetime& d) : base_format(d) {} };
   /* HHMM         */ struct time_format6 : public base_format { time_format6(datetime& d) : base_format(d) {} };
   /* HHMMSS       */ struct time_format7 : public base_format { time_format7(datetime& d) : base_format(d) {} };
   /* HHMMSSmss    */ struct time_format8 : public base_format { time_format8(datetime& d) : base_format(d) {} };

   /* YYYYMMDD HH:MM:SS.mss    */ struct datetime_format00 : public base_format { datetime_format00(datetime& d) : base_format(d) {} };
   /* YYYY/MM/DD HH:MM:SS.mss  */ struct datetime_format01 : public base_format { datetime_format01(datetime& d) : base_format(d) {} };
   /* DD/MM/YYYY HH:MM:SS.mss  */ struct datetime_format02 : public base_format { datetime_format02(datetime& d) : base_format(d) {} };
   /* YYYYMMDD HH:MM:SS        */ struct datetime_format03 : public base_format { datetime_format03(datetime& d) : base_format(d) {} };
   /* YYYY/MM/DD HH:MM:SS      */ struct datetime_format04 : public base_format { datetime_format04(datetime& d) : base_format(d) {} };
   /* DD/MM/YYYY HH:MM:SS      */ struct datetime_format05 : public base_format { datetime_format05(datetime& d) : base_format(d) {} };
   /* YYYY-MM-DD HH:MM:SS.mss  */ struct datetime_format06 : public base_format { datetime_format06(datetime& d) : base_format(d) {} };
   /* DD-MM-YYYY HH:MM:SS.mss  */ struct datetime_format07 : public base_format { datetime_format07(datetime& d) : base_format(d) {} };
   /* YYYY-MM-DD HH:MM:SS      */ struct datetime_format08 : public base_format { datetime_format08(datetime& d) : base_format(d) {} };
   /* DD-MM-YYYY HH:MM:SS      */ struct datetime_format09 : public base_format { datetime_format09(datetime& d) : base_format(d) {} };
   /* YYYY-MM-DDTHH:MM:SS      */ struct datetime_format10 : public base_format { datetime_format10(datetime& d) : base_format(d) {} };
   /* YYYY-MM-DDTHH:MM:SS.mss  */ struct datetime_format11 : public base_format { datetime_format11(datetime& d) : base_format(d) {} };
   /* YYYYMMDDTHH:MM:SS        */ struct datetime_format12 : public base_format { datetime_format12(datetime& d) : base_format(d) {} };
   /* YYYYMMDDTHH:MM:SS.mss    */ struct datetime_format13 : public base_format { datetime_format13(datetime& d) : base_format(d) {} };
   /* DD-MM-YYYYTHH:MM:SS.mss  */ struct datetime_format14 : public base_format { datetime_format14(datetime& d) : base_format(d) {} };
   /* DD-MM-YYYYTHH:MM:SS      */ struct datetime_format15 : public base_format { datetime_format15(datetime& d) : base_format(d) {} };
   /* YYYYMMDDTHHMM            */ struct datetime_format16 : public base_format { datetime_format16(datetime& d) : base_format(d) {} };
   /* YYYYMMDDTHHMMSS          */ struct datetime_format17 : public base_format { datetime_format17(datetime& d) : base_format(d) {} };
   /* YYYYMMDDTHHMMSSMSS       */ struct datetime_format18 : public base_format { datetime_format18(datetime& d) : base_format(d) {} };
   /* ISO8601 DateThh:mm:ssTZD */ struct datetime_format19 : public base_format { datetime_format19(datetime& d) : base_format(d) {} };
   /* ISO8601 DateThh:mmTZD    */ struct datetime_format20 : public base_format { datetime_format20(datetime& d) : base_format(d) {} };
   /* NCSA Common Log DateTime */ struct datetime_format21 : public base_format { datetime_format21(datetime& d) : base_format(d) {} };
   /* RFC-822 HTTP DateTime    */ struct datetime_format22 : public base_format { datetime_format22(datetime& d) : base_format(d) {} };
   /* YYYYMMDD HH:MM:SS.nss    */ struct datetime_format23 : public base_format { datetime_format23(datetime& d) : base_format(d) {} };
   /* YYYY/MM/DD HH:MM:SS.nss  */ struct datetime_format24 : public base_format { datetime_format24(datetime& d) : base_format(d) {} };
   /* DD/MM/YYYY HH:MM:SS.nss  */ struct datetime_format25 : public base_format { datetime_format25(datetime& d) : base_format(d) {} };
   /* YYYY-MM-DD HH:MM:SS.mss  */ struct datetime_format26 : public base_format { datetime_format26(datetime& d) : base_format(d) {} };
   /* DD-MM-YYYY HH:MM:SS.mss  */ struct datetime_format27 : public base_format { datetime_format27(datetime& d) : base_format(d) {} };
   /* YYYY-MM-DDTHH:MM:SS.mss  */ struct datetime_format28 : public base_format { datetime_format28(datetime& d) : base_format(d) {} };
   /* YYYYMMDDTHH:MM:SS.nss    */ struct datetime_format29 : public base_format { datetime_format29(datetime& d) : base_format(d) {} };
   /* DD-MM-YYYYTHH:MM:SS.nss  */ struct datetime_format30 : public base_format { datetime_format30(datetime& d) : base_format(d) {} };
   /* YYYYMMDDTHHMMSSNSS       */ struct datetime_format31 : public base_format { datetime_format31(datetime& d) : base_format(d) {} };
   /* ISO8601 DateThh:mm:ss.mssTZD  */ struct datetime_format32 : public base_format { datetime_format32(datetime& d) : base_format(d) {} };
   /* ISO8601 DateThh:mm:ss.nssTZD  */ struct datetime_format33 : public base_format { datetime_format33(datetime& d) : base_format(d) {} };
